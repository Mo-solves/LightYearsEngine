...
namespace ly
{
	...
	{
	public:
		Timer(weak<Object> weakRef, std::function<void()> callback,
	...
	public:
		...
		unsigned int SetTimer(weak<Object> weakRef, void(ClassName::* callback)(),
			float duration, bool repeat = false)
		{
			++timerIndexCounter;
			mTimers.insert({ timerIndexCounter, Timer(weakRef,
